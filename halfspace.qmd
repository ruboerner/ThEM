...
To make both terms in brackets compatible, we use the _Weber integral_
$$
...
We exclude the source term from the integral and write with the help of @eq-sommerfeld
$$F^0(r,z) = \frac{i\omega\mu m}{4 \pi} 
\left[
...
We will call this function `B₁` and refer to it as the _admittance of the layered halfspace_.

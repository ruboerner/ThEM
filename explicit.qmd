...
The last plot for $B_z$ can be verified using Fig. 4.2 in Ward & Hohmann:

![](https://ruboerner.github.io/images/Hz_VMD.png)

Note that $H_z$ is plotted in the above figure.

For completeness, this is Fig. 4.3 of Ward & Hohmann, which displays $H_r$:

...
Note that $r_n := \dfrac{\gamma_n^+}{\gamma_n^-}$ is the ratio of the amplitudes of upward (reflected) and downward (transmitted) travelling waves at the interface at $z=h_n$.

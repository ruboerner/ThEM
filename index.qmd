...
Here are the lecture notes for the 2026 module covering the **Theory of Electromagnetic Methods.** These notes are tailored for Master's students of Geophysics and Geoinformatics at the [Institute of Geophysics and Geoinformatics, TU Bergakademie Freiberg](https://tu-freiberg.de/geophysik).
...
For an optimal experience, we recommend installing Python via [*miniforge*](https://conda-forge.org/).

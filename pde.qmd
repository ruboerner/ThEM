...
To conclude, we can safely assume that the second term, $\eta_2$, can be neglected for frequencies less than $10^5$ Hz for the lowest reasonable value of the conductivity in the Earth. For higher conductivities, the result becomes even more pronounced.
...
Check: For $\rho = 100~\Omega \cdot m$ and $f = 1$ s, the skin depth is approximately
$$
